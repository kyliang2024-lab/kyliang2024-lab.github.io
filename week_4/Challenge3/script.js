...
function show(button_element) {
    ...
    */
    ...
    let ta_name = button_element.id;
    console.log(ta_name);

    //infobox
    // let funfact_Ta = facts[document.getElementById("left-child")];
    let funfact_Ta = facts[ta_name];
    console.log(funfact_Ta);
    
    //update paragrah
    document.getElementById("ta-fun-fact").textContent =funfact_Ta;
    ...
    document.getElementById("ta-photo").src ="photos/"+ta_name+".jpg";
